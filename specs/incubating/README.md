...
| [`stac-geoparquet.md`](stac-geoparquet.md) | Partly graduated — raster item mirrors are normative; catalog-root `collections.parquet` and `catalogs.parquet` proposed in August 2026 ([#44](https://github.com/portolan-sdi/portolan-spec/issues/44), upstream [#17](https://github.com/radiantearth/stac-geoparquet-spec/issues/17)) |
